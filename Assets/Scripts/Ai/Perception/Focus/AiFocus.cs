...
namespace Ai
{
    ...
    /// Version of focus with additional helper functions
    public abstract class FocusOwned : FocusBase
    {
        protected FocusOwned(Transform transform)
        {
    ...
    public class FocusStore : FocusOwned
    {
